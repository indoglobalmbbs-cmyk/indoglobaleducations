...
const UlyanovskStateUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Ulyanovsk State Medical University was founded in 1988 and is
              located in the city of Ulyanovsk, Russia. It is one of the most
              popular universities in Russia that provides the best medical
              education to foreign students. Students have the flexibility to
              choose medical programmes based on their interests, as the
              university offers a variety of options to suit different career
              paths. Ulyanovsk Medical University, Russia is ranked among the
              top medical universities in Russia, The university has become the
              best choice for Indian students who are looking for MBBS in
              Russia. The university has renowned professors who provide
              high-quality education to Indian students in English. The
              university is equipped with scientific laboratories, a
              well-stocked library and offers hostel facilities with ample
              accommodation for international students.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={ulyanovskstateuniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Ulyanovsk State University is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Ulyanovsk State University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Ulyanovsk State University is recognized as one of
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Ulyanovsk State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Ulyanovsk State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Ulyanovsk State University library is a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Ulyanovsk State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Ulyanovsk State University
            </div>
...
export default UlyanovskStateUniversity;
