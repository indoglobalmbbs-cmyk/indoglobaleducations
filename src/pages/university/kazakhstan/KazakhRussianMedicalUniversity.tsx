...
const KazakhRussianMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Kazakh Russian Medical University, established in 1992, is one of
              Kazakhstan's most well-known medical university. The college is
              located in Almaty, Kazakhstan, and is recognised by Medical
              Council of India. The university is famous for its high-quality
              education, advanced infrastructure, and globally recognized
              medical sciences. Students who want to pursue MBBS in Kazakhstan
              should consider KRMU as a better university for them. The Kazakh
              Russian Medical University has a 33 years of history providing an
              excellent MBBS curriculum that meets worldwide medical standards.
              Kazakh Russian Medical University has approximately 962 professors
              and teaching staff, 7,000 students and 24 departments, where all
              subjects are taught in English. Students who enroll at KRMU get
              many advantages, including a high rating, affordable tuition fees,
              low living expenses, and a large number of Indian students, etc.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={kazakhrussianmedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Kazakh-Russian Medical University is a leading institution for
                medical education in Kazakhstan, offering a globally recognized
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Kazakh-Russian Medical University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Kazakh-Russian Medical University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Kazakh-Russian Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Kazakh-Russian Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Kazakh-Russian Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Kazakh-Russian Medical University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Kazakh-Russian Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Kazakh-Russian Medical University
            </div>
...
export default KazakhRussianMedicalUniversity;
