...
const DavidAghmashenebeliUniversityOfGeorgia = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              David Agmashenebeli University of Georgia (DAUG) was founded in
              1992. It has been established as an educational and scientific hub
              of international standards, which offers quality education. It
              aims to develop the personality of every - personally and
              professionally to prepare them for highly competitive and modern
              competencies. The university has modern infrastructure, conference
              hall, educational audiences, computer centres, sports halls, press
              club, library and First Aid Training Center. There are highly
              qualified professors which offer theoretical as well as practical
              knowledge. The centres are fully equipped with modern technologies
              for the development of student’s practical skills and to enhance
              their knowledge.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={davidaghmashenebeliuniversityofgeorgia}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About David Aghmashenebeli University Of Georgia
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                David Aghmashenebeli University Of Georgia is a leading
                institution for medical education in Georgia, offering a
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for David Aghmashenebeli University Of Georgia
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for David Aghmashenebeli University Of Georgia
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the David Aghmashenebeli University Of
                Georgia library is a cornerstone of academic life. It houses a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                David Aghmashenebeli University Of Georgia provides a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at David Aghmashenebeli University Of Georgia
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at David Aghmashenebeli University Of Georgia
            </div>
...
export default DavidAghmashenebeliUniversityOfGeorgia;
