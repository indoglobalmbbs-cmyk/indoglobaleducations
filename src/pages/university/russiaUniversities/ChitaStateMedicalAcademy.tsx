          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Chita State Medical Academy</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Chita State Medical Academy is recognized by the World Health
              Organization (WHO) and is listed in the National Medical
              Commission (NMC) of India. The MBBS course is taught in English,
              ensuring international students can study comfortably without any
              language barrier. With over 70 years of experience in medical
              education, the university has developed a reputation for producing
              skilled doctors and healthcare professionals. Students benefit
              from advanced clinical training in well-equipped hospitals,
              practical exposure, and a curriculum aligned with global medical
              standards. The university's faculty includes highly qualified
              professors, doctors, and researchers committed to delivering
              in-depth medical knowledge using innovative teaching methods and
              hands-on practice.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={chitastatemedicalacademy}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Chita State Medical Academy
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Chita State Medical Academy is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Chita State Medical Academy has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Chita State Medical Academy is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Chita State Medical Academy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Chita State Medical Academy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Chita State Medical Academy library is
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Chita State Medical Academy provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Chita State Medical Academy
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Chita State Medical Academy
            </div>
