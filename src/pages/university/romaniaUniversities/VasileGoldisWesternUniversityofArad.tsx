...
const VasileGoldisWesternUniversityofArad = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              The Western University of „Vasile Goldiș” in Arad (Romanian:
              Universitatea de Vest "Vasile Goldiș") is a private university
              located in Arad, Romania. The spiritual patron of the university
              is Vasile Goldiș, a prominent Romanian politician, pedagogue,
              publicist, member of the Romanian Academy and a key figure of the
              Union of Transylvania with Romania in 1918. The Faculty of Law was
              founded in the first year of operation of the University in
              1990-1991. It is the first private law school in Romania, whose
              final accreditation was confirmed by the Romanian Parliament in
              March 2002. Since the academic year 2012-2013, the Faculty of Law
              has a new leadership that strives to continue the rich tradition
              of the legal school of Arad and to strengthen ties with the
              European legal elite.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={vasilegoldiswesternuniversityofarad}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Vasile Goldis Western University of Arad
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Vasile Goldis Western University of Arad is a leading
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Vasile Goldis Western University of Arad has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Vasile Goldis Western University of Arad is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Vasile Goldis Western University of Arad
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Vasile Goldis Western University of Arad
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Vasile Goldis Western University of
                Arad library is a cornerstone of academic life. It houses a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Vasile Goldis Western University of Arad provides a comfortable
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Vasile Goldis Western University of Arad
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Vasile Goldis Western University of Arad
            </div>
...
export default VasileGoldisWesternUniversityofArad;
