...
const IzhevskStateMedicalAcademy = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Izhevsk State Medical Academy is a prominent higher education
              institution in the Russian Federation, renowned for its medical
              education and scientific contributions. Established in 1933, the
              academy boasts over 80 years of experience in training medical
              professionals, having produced more than 21,500 doctors and
              nursing managers. ISMA takes pride in its highly qualified
              teaching staff, advanced researchers, and experienced physicians
              with global recognition. The university is a preferred choice for
              the aspiring who wants to study MBBS abroad. Currently, the
              academy employs 351 teachers, including 86 Doctors of Medicine and
              212 Candidates of Medicine, who deliver high-quality instruction
              across 52 departments and 28 clinical bases.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={izhevskstatemedicalacademy}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Izhevsk State Medical Academy is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Izhevsk State Medical Academy has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Izhevsk State Medical Academy is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Izhevsk State Medical Academy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Izhevsk State Medical Academy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Izhevsk State Medical Academy library
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Izhevsk State Medical Academy provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Izhevsk State Medical Academy
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Izhevsk State Medical Academy
            </div>
...
export default IzhevskStateMedicalAcademy;
