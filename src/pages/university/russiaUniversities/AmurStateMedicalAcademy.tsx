          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Amur State Medical Academy</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Amur State Medical Academy is the best medical institute
              established in 1952. It is one of the oldest universities in the
              Russian Amur State University is ranked among the top medical
              colleges in Russia to pursue quality medical education at low
              tuition fees. International candidates who get admission here can
              experience better accommodations like world-class infrastructure,
              Wi-Fi-enabled buildings, hostels, mess, and more. It is listed in
              NMC Approved Medical Colleges in Russia and provides education to
              aspirants according to European standards, as indicated in the
              list of medical schools in Europe. Federation, maintaining the
              tradition of quality education through highly educated professors.
              It is the fastest-growing university situated in the city of
              Blagoveshchensk, Russia.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={amurstatemedicalacademy}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Amur State Medical Academy
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Amur State Medical Academy is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Amur State Medical Academy has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Amur State Medical Academy is recognized as one of
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Amur State Medical Academy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Amur State Medical Academy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Amur State Medical Academy library is a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Amur State Medical Academy provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Amur State Medical Academy
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Amur State Medical Academy
            </div>
...
export default AmurStateMedicalAcademy;
