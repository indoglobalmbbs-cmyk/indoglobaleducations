...
const OvidiusUniversityofConstanta = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Ovidius University of Constanța is a public higher education
              institution founded in 1961 and transformed into a comprehensive
              university in 1990. It has study programs in medical and natural
              sciences, humanities and engineering, social and economic
              sciences, law and administrative sciences, theology and arts.
              Ovidius University of Constanța offers nationally and
              internationally accredited programs at all three levels of study,
              the bachelor’s, master’s and doctoral degrees offered being
              recognized in the entire European Union and beyond. With over
              15,000 students, of which about 1200 are international, it is the
              largest university in South-East Romania and the largest
              university of the European Union at the Black Sea.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={ovidiusuniversityofconstanta}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Ovidius University of Constanta
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Ovidius University of Constanta is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Ovidius University of Constanta has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Ovidius University of Constanta is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Ovidius University of Constanta
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Ovidius University of Constanta
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Ovidius University of Constanta library
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Ovidius University of Constanta provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Ovidius University of Constanta
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Ovidius University of Constanta
            </div>
...
export default OvidiusUniversityofConstanta;
