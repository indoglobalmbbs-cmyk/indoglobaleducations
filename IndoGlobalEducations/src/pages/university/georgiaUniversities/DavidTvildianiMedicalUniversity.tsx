        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              David Tvildiani Medical University is functioning since 1992-93
              offering Higher Education especially in the field of medicine. It
              is officially recognized by MCI & enlisted with WDOMS. The
              university offers quality higher education and the best
              international experience in medicine. It focuses on continuous
              improvement in teaching, learning, research & management quality.
              It has a modern infrastructure and healthy environment which
              promotes learning, development and active participation of
              students. The university has 476 graduates and currently, there
              are 884 Georgian and foreign students studying diploma in
              medicine, a diploma in medical and e-PD and doctoral programs.
              Around 271 employees are facilitating academic, administrative,
              other teaching and research at the university. There are 7
              departments: 5 combines 39 disciplines (directions) to cover 74
              courses in different modes to deliver training in
              scientific-research and clinical skills of departments.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={davidtvildianimedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                David Tvildiani Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  David Tvildiani Medical University has played a pivotal role
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, David Tvildiani Medical University is recognized
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for David Tvildiani Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for David Tvildiani Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the David Tvildiani Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                David Tvildiani Medical University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at David Tvildiani Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at David Tvildiani Medical University
            </div>
