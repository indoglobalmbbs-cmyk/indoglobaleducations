...
const AllIndiaInstituteOfMedicalSciencesDelhi = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              The idea of AIIMS arose in 1946, after a recommendation by the
              Health Survey of the Government of India. From then to the
              establishment and development of AIIMS (New Delhi) over the
              ensuing years, several illustrious individuals played their part
              in bringing the idea to fruition. Originally proposed by the then
              Prime Minister of India Jawaharlal Nehru for establishment in
              Calcutta, it was established in New Delhi following the refusal of
              Chief Minister of West Bengal Bidhan Chandra Roy. The foundation
              stone of AIIMS Delhi was laid in 1952. On 18 February 1956, the
              then Minister of Health, Rajkumari Amrit Kaur, introduced a new
              bill in the Lok Sabha, that would eventually become the AIIMS Act.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={allindiainstituteofmedicalsciencesdelhi}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                All India Institute Of Medical Sciences Delhi is a leading
                institution for medical education in India, offering a globally
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  All India Institute Of Medical Sciences Delhi has played a
                  pivotal role in the advancement of medical sciences and the
                  education of medical professionals. Consistently ranked among
                  the <strong>top 10 medical institutes in India</strong>, it
                  stands out in the yearly official ratings among the 48 Indian
                  Institutes of Medical Education.
                </p>
                <p className="text-text-muted leading-relaxed">
                  As of 2018, All India Institute Of Medical Sciences Delhi is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for All India Institute Of Medical Sciences
              Delhi
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for All India Institute Of Medical Sciences
              Delhi
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the All India Institute Of Medical Sciences
                Delhi library is a cornerstone of academic life. It houses a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                All India Institute Of Medical Sciences Delhi provides a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at All India Institute Of Medical Sciences Delhi
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at All India Institute Of Medical Sciences Delhi
            </div>
...
export default AllIndiaInstituteOfMedicalSciencesDelhi;
