...
const ChechenStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Chechen State University is a prestigious educational institution
              in Russia. It aims to provide quality education and promote
              excellence in studies. The university is affiliated with the
              Ministry of Education and Science of the Russian Federation and is
              approved by the Ministry of Public Health of the Russian
              Federation, the Ministry of Education and Science of the Russian
              Federation, the WHO, and the NMC of India. It is an excellent
              option for foreign students to study MBBS in Russia and is
              internationally recognized. The university has a wide range of
              learning courses designed for students all over the world. It has
              courses in fields like business administration, computer science,
              engineering, and health sciences, among others. Students can also
              pursue MBBS abroad programs from the university. The MBBS course
              is a 6-year undergraduate medical course that provides MD (Doctor
              of Medicine) or MBBS degree to the students. The course is taught
              both in English and Russian language to make it accessible to more
              students.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={chechenstatemedicaluniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Chechen State Medical University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Chechen State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Chechen State Medical University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Chechen State Medical University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Chechen State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Chechen State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Chechen State Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Chechen State Medical University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Chechen State Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Chechen State Medical University
            </div>
...
export default ChechenStateMedicalUniversity;
