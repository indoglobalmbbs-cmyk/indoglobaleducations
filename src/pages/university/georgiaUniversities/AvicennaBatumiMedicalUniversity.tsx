...
const AvicennaBatumiMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              ...
              its motto, "learning for life" into a tangible reality through the
              implementation of modern and innovative methods in teaching,
              learning, and research that adhere to Western standards. The
              university places a strong emphasis on internationalization and
              the cultivation of international relations, which are essential
              for fostering a global academic environment. By focusing on the
              development and sharing of knowledge, the university strives to
              become a renowned academic platform, offering superior quality
              medical education. Its commitment to these principles guarantees
              that students receive a thorough and state of the art education
              that prepares them for lifelong learning and professional
              excellence in the medical field. The university teaches to work by
              focusing on history of the patient, prevention of the disease to
              recovery. This helps to achieve an inclusive quality of healthcare
              these qualities makes it the first choice for MBBS Abroad in
              Georgia.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={avicennabatumimedicaluniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Avicenna - Batumi Medical University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Avicenna - Batumi Medical University is a leading institution
                for medical education in Georgia, offering a globally recognized
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Avicenna - Batumi Medical University has played a pivotal role
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Avicenna - Batumi Medical University is recognized
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Avicenna - Batumi Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Avicenna - Batumi Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Avicenna - Batumi Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Avicenna - Batumi Medical University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Avicenna - Batumi Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Avicenna - Batumi Medical University
            </div>
...
export default AvicennaBatumiMedicalUniversity;
