...
const AstrakhanStateUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Astrakhan State Medical University is one of the most well known
              and reputed universities in the Russian Federation. The university
              is located in the city of Astrakhan which is in Southern Russia.
              The university was founded on November 7, 1918 with the full name
              of “Federal State Budgetary Educational Institution of Higher
              Education Astrakhan State Medical University of the Ministry of
              Health of the Russian Federation”. The university is censored to
              be the first choice for pursuing MBBS in Russia. The University
              has more than 56 departments which includes multiple medical
              programs such as general medicine, dentistry, pharmacy,
              pediatrics, nursing and many such related programs and courses.
              These courses are globally recognised by the NMC, WHO, MCI, FAIMER
              and many such related organisations.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={astrakhanstateuniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Astrakhan State University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Astrakhan State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Astrakhan State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Astrakhan State University library is a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Astrakhan State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Astrakhan State University
            </div>
...
export default AstrakhanStateUniversity;
