...
const MaulanaAzadMedicalCollege = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Maulana Azad Medical College (MAMC) is a public medical college in
              New Delhi, India, affiliated to the University of Delhi. It is
              named after Indian freedom fighter and first education minister of
              India Maulana Abul Kalam Azad. It was established in 1958 at
              Bahadur Shah Zafar Marg near Delhi Gate. Four hospitals attached
              to MAMC have a combined bed strength of 2800 beds and cater to
              millions in Delhi alone and many more from the surrounding states
              in north India. The college is a tertiary care referral centre and
              has teaching programs for graduate and postgraduate degrees and
              residency and subspecialities/fellowships (referred to as
              superspecialities in India).
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={maulanaazadmedicalcollege}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Maulana Azad Medical College is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Maulana Azad Medical College has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Maulana Azad Medical College is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Maulana Azad Medical College
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Maulana Azad Medical College
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Maulana Azad Medical College library is
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Maulana Azad Medical College provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Maulana Azad Medical College
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Maulana Azad Medical College
            </div>
...
export default MaulanaAzadMedicalCollege;
