...
const WestKazakhstanMaratOspanovStateMedicalUniversity = () => {
          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                Study MBBS in Kazakhstan at <br />
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              West Kazakhstan Marat Ospanov State Medical University is a
              popular medical university in Kazakhstan. It is located in Aktobe,
              Kazakhstan, which is renowned for its medical education. WKSMU is
              a government university that was founded in 1957. The university
              offers a top-quality medical education with healthcare services,
              making it a first choice for various students who want to MBBS
              Abroad. The college provides its students with 5 academic and lab
              buildings, 5 hostels with 2,100 seats, the 700-seat A. Doszhanova
              Hall, and an advanced scientific library. A total of 79
              educational programs are being offered by Marat Ospanov WKMU in
              the academic session 2026-27, including 17 undergraduate, 46
              residency, and 13 master's degree programs.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={westkazakhstanmaratospanovstatemedicaluniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About West Kazakhstan Marat Ospanov State Medical University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                West Kazakhstan Marat Ospanov State Medical University is a
                leading institution for medical education in Kazakhstan,
                offering a globally recognized MD program. With a focus on
                practical clinical training and modern research, we prepare
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  West Kazakhstan Marat Ospanov State Medical University has
                  played a pivotal role in the advancement of medical sciences
                  and the education of medical professionals. Consistently
                  ranked among the{' '}
                  <strong>top 10 medical institutes in Kazakhstan</strong>, it
                  stands out in the yearly official ratings among the 48
                  Kazakhstan Institutes of Medical Education.
                </p>
                <p className="text-text-muted leading-relaxed">
                  As of 2018, West Kazakhstan Marat Ospanov State Medical
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for West Kazakhstan Marat Ospanov State Medical
              University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for West Kazakhstan Marat Ospanov State Medical
              University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the West Kazakhstan Marat Ospanov State
                ...
                of books from both Kazakhstan and international authors.
              </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                West Kazakhstan Marat Ospanov State Medical University provides
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at West Kazakhstan Marat Ospanov State Medical
              University
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 bg-surface rounded-2xl border-l-4 border-primary shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                ...
                is standardized across Kazakhstan medical universities to ensure
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              Explore other premier medical institutions in Kazakhstan
              recognized for their academic excellence and global clinical
              standards.
            </p>
          </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at West Kazakhstan Marat Ospanov State Medical University
            </div>
...
export default WestKazakhstanMaratOspanovStateMedicalUniversity;
