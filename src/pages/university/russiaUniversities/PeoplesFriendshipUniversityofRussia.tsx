...
const PeoplesFriendshipUniversityofRussia = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              The Peoples’ Friendship University of Russia is one of the top
              medical universities of Russia for MBBS in Russia. The Peoples’
              Friendship University of Russia is an educational and research
              institution located in southern Moscow. It is ranked by the
              Ministry of Education of Russia as the country’s third-best
              university after Moscow State University and Saint Petersburg
              State University. The Peoples’ Friendship University is one of the
              medical universities for Russia recognized by MCI, WHO, UK, USA
              and other major countries. It is the only university in the world
              every year uniting students from 145-150 countries. More than 77
              thousand graduates of the University work in 170 countries, among
              them more than 5500 holders of PhD and Doctorate degrees. It has a
              team of 4,500 employees, among them 2,826 highly qualified
              teachers.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={peoplesfriendshipuniversityofrussia}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Peoples' Friendship University of Russia
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Peoples' Friendship University of Russia is a leading
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Peoples' Friendship University of Russia has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Peoples' Friendship University of Russia is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Peoples' Friendship University of Russia
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Peoples' Friendship University of Russia
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Peoples' Friendship University of
                Russia library is a cornerstone of academic life. It houses a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Peoples' Friendship University of Russia provides a comfortable
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Peoples' Friendship University of Russia
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Peoples' Friendship University of Russia
            </div>
...
export default PeoplesFriendshipUniversityofRussia;
