        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Altai State Medical University was earlier known as Altai State
              Medical Institute. It was founded in 1954, in Barnaul city, Altai
              region in Russia. Altai State Medical University is acknowledged
              by the Ministry of Education and Science of the Russian
              Federation. The university is known to conduct high-quality
              training programs with 25,000 leading teams of doctors and
              pharmaceutics for the regional healthcare system. The university
              stands among one of the central hubs for research, education and
              cultural exchange. Since years, the university has produced around
              30,000 graduates. Yearly, around 4000 students appear for medical
              programs at the university. The Academic Staff of the University
              consists of more than 100 doctors and 350 candidates of science, 3
              Corresponding Members of RAMS, 5 Honored Scientists of Russia, 25
              distinguished physicians Russia and 10 honored workers of the
              Graduate School.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={altaistatemedicaluniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Altai State Medical University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Altai State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Altai State Medical University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Altai State Medical University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Altai State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Altai State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Altai State Medical University library
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Altai State Medical University provides a comfortable and secure
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Altai State Medical University
            </div>
