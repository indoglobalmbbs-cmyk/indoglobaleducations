...
const KokshetauStateUniversity = () => {
          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Kokshetau State University</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Kokshetau State University is a government university in
              Kazakhstan which was established in 1962. It is one of the oldest
              university for higher medical education. This university is known
              for its affordable MBBS program, especially for international
              students. The university is recognized by the World Health
              Organization (WHO) and approved by the National Medical Commission
              (NMC) of India. Kokshetau State University offers great
              opportunities and practical knowledge at an affordable fee. The
              university was named after Shokan Ualikhanov who was one of the
              greatest Kazakh scientists, historians, ethnographers,
              geographers, translators, and travelers. Around 7000 students are
              studying at the medical faculty in Kokshetau State University in
              which over 1000 are foreign students from different countries.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={kokshetaustateuniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Kokshetau State University is a leading institution for medical
                education in Kazakhstan, offering a globally recognized MD
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Kokshetau State University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Kokshetau State University is recognized as one of
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Kokshetau State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Kokshetau State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Kokshetau State University library is a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Kokshetau State University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Kokshetau State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Kokshetau State University
            </div>
...
export default KokshetauStateUniversity;
