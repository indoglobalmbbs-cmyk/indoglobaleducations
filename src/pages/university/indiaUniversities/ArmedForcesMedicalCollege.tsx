...
const ArmedForcesMedicalCollege = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              The Armed Forces Medical College (AFMC) is a medical school in
              Pune, India, in the state of Maharashtra. The college is managed
              by the Indian Armed Forces. Established in May 1948 as a
              post-graduate teaching institution after World War II on the
              recommendation of the BC Roy Committee, remnants of various Indian
              Army Medical Corps units were amalgamated to create the Armed
              Forces Medical Services. The AFMC undergraduate wing was
              established on 4 August 1962, which is also celebrated annually as
              AFMC Day by its alumni. The institution primarily provides
              training to medical undergraduates and postgraduates, dental
              postgraduates, nursing cadets and paramedical staff. Patient care
              forms an integral part of its training curriculum and the attached
              hospitals benefits from the expertise available at AFMC. The
              institution is responsible for providing the entire pool of
              specialists and super specialists to the Armed Forces. The college
              is also involved in conducting research in various medical
              subjects as well as those aspects which would affect the morale
              and performance of the Armed Forces both in war and peace.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={armedforcesmedicalcollege}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Armed Forces Medical College is a leading institution for
                medical education in India, offering a globally recognized MD
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Armed Forces Medical College has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Armed Forces Medical College is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Armed Forces Medical College
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Armed Forces Medical College
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Armed Forces Medical College provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Armed Forces Medical College
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Armed Forces Medical College
            </div>
...
export default ArmedForcesMedicalCollege;
