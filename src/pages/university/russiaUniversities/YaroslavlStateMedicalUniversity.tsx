...
const YaroslavlStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Established in 1944, Yaroslavl State Medical University is a
              center for quality medical education and biomedical research. The
              university facilitates medical training, specialist retraining,
              and doctoral education with the help of a highly skilled academic
              staff. With 6 faculties in medicine, healthcare, and pharmacy, the
              university aims to create future physicians who contribute to the
              community's health and well-being by implementing their ethical
              values, and skills learned and practiced during the MD course.
              Including international students, there are at least 4,000
              students who are receiving high-quality medical training, at local
              hospitals and medical institutions in Russia. Facilities such as a
              sports center, Volga River summer camp, student healthcare center,
              and a botanical garden are some recreational facilities at
              Yaroslavl State Medical University.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={yaroslavlstatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Yaroslavl State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Yaroslavl State Medical University has played a pivotal role
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Yaroslavl State Medical University is recognized
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Yaroslavl State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Yaroslavl State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Yaroslavl State Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Yaroslavl State Medical University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Yaroslavl State Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Yaroslavl State Medical University
            </div>
...
export default YaroslavlStateMedicalUniversity;
