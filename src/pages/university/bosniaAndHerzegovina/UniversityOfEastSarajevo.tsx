...
const UniversityOfEastSarajevo = () => {
          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                Study MBBS in Bosnia And Herzegovina at <br />
                <span className="text-accent">University Of East Sarajevo</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              The University of East Sarajevo is a govt. university in Bosnia
              and Herzegovina. The Faculty of Medicine is located in Foča and
              was founded in 1993, making it one among the oldest medical
              faculties to study MBBS in Bosnia. The faculty of medicine at the
              University of East Sarajevo has a facility spanning over 6000 sq.
              meters, equipped with modern infrastructure for high-quality
              education. The Faculty of Medicine, Foca is a respectable teaching
              institution and its diploma is highly recognized and accepted
              across Europe and the world. The University of East Sarajevo was
              established in 1992 under the name University of Sarajevo. The
              University inherits the tradition of the first higher education
              institutions in the region, dating back to 1882. The teaching
              process in the University started in the academic year of 1993-94.
              Today, it is the best university in Bosnia for studying medicine
              (MBBS).
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={universityofeastsarajevo}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About University Of East Sarajevo
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                University Of East Sarajevo is a leading institution for medical
                education in Bosnia And Herzegovina, offering a globally
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  University Of East Sarajevo has played a pivotal role in the
                  advancement of medical sciences and the education of medical
                  professionals. Consistently ranked among the{' '}
                  <strong>
                    top 10 medical institutes in Bosnia And Herzegovina
                  </strong>
                  , it stands out in the yearly official ratings among the 48
                  Bosnia And Herzegovina Institutes of Medical Education.
                </p>
                <p className="text-text-muted leading-relaxed">
                  As of 2018, University Of East Sarajevo is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for University Of East Sarajevo
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for University Of East Sarajevo
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the University Of East Sarajevo library is
                a cornerstone of academic life. It houses a massive collection
                of over <strong className="text-primary">440,000 copies</strong>
                of books from both Bosnia And Herzegovina and international
                authors.
              </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                University Of East Sarajevo provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at University Of East Sarajevo
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 bg-surface rounded-2xl border-l-4 border-primary shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                ...
                is standardized across Bosnia And Herzegovina medical
                universities to ensure comprehensive training.
              </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-surface p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              <p className="text-text-muted text-sm mb-4">
                ...
                to other Bosnia And Herzegovina hubs.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  {[
                    'NMC (India) Approved',
                    'WHO Recognized',
                    'Top 10 Ranked in Bosnia And Herzegovina',
                    'Research Oriented',
                  ].map((item, i) => (
                    <div
                      key={i}
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              Explore other premier medical institutions in Bosnia And
              Herzegovina recognized for their academic excellence and global
              clinical standards.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <div className="text-3xl md:text-4xl font-bold mb-6">
                Why Choose{' '}
                <span className="text-accent">University Of East Sarajevo</span>{' '}
                for MBBS in Bosnia And Herzegovina?
              </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at University Of East Sarajevo
            </div>
...
export default UniversityOfEastSarajevo;
