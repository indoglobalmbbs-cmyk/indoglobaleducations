...
const DunareadeJosUniversityofGalati = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Dunarea de Jos University of Galati (UDJG) represents, for the
              South-East Region of Romania, a pole of academic excellence that
              concentrates the elite human resource, specialized in the training
              of professionals in numerous fields, of an entire area with
              national and international openness. In 74 years of existence, the
              institution has expanded and modernized, coagulating an academic
              community focused on achieving performance in teaching and
              research and thus becoming a European-level university based on
              both a modern and competitive didactic process – collaborative
              with students at all levels, on fundamental and applied scientific
              research, as well as on the excellent relationships it has
              developed with the local and regional business environment and
              local community structures.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={dunareadejosuniversityofgalati}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About "Dunarea de Jos" University of Galati
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                "Dunarea de Jos" University of Galati is a leading institution
                for medical education in Romania, offering a globally recognized
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  "Dunarea de Jos" University of Galati has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, "Dunarea de Jos" University of Galati is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for "Dunarea de Jos" University of Galati
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for "Dunarea de Jos" University of Galati
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the "Dunarea de Jos" University of Galati
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                "Dunarea de Jos" University of Galati provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at "Dunarea de Jos" University of Galati
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at "Dunarea de Jos" University of Galati
            </div>
...
export default DunareadeJosUniversityofGalati;
