...
const JawaharlalInstituteOfPostgraduateMedicalEducationAndResearch = () => {
    ...
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              ...
              Research (JIPMER) is a medical school located in Pondicherry,
              India. JIPMER is an Institute of National Importance (INI) and a
              tertiary care referral hospital. It is under the direct
              administrative control of the Ministry of Health and Family
              Welfare, and Government of India, with autonomy to run its
              internal administration. JIPMER currently has over 300 faculty
              members, over 700 resident physicians and over 800 nursing,
              administrative, and support staff. It admits 249 undergraduate
              students and 200 postgraduate students annually.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={jawaharlalinstituteofpostgraduatemedicaleducationandresearch}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Jawaharlal Institute of Postgraduate Medical Education
                  and Research
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Jawaharlal Institute of Postgraduate Medical Education and
                Research is a leading institution for medical education in
                India, offering a globally recognized MD program. With a focus
                on practical clinical training and modern research, we prepare
                students for successful careers in healthcare worldwide.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  ...
                  medical sciences and the education of medical professionals.
                  Consistently ranked among the{' '}
                  <strong>top 10 medical institutes in India</strong>, it stands
                  out in the yearly official ratings among the 48 Indian
                  Institutes of Medical Education.
                </p>
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Jawaharlal Institute of Postgraduate Medical
                  Education and Research is recognized as one of the largest
                  centers for medical research, education, and science. The
                  Academy is renowned for its highly qualified teaching staff,
                  extensive laboratory facilities, and robust clinical base.
                </p>
              </div>
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Jawaharlal Institute of Postgraduate
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Jawaharlal Institute of Postgraduate Medical
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Jawaharlal Institute of Postgraduate
                Medical Education and Research library is a cornerstone of
                academic life. It houses a massive collection of over{' '}
                <strong className="text-primary">440,000 copies</strong> of
                books from both Indian and international authors.
              </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Jawaharlal Institute of Postgraduate Medical Education and
                Research provides a comfortable and secure living environment
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Jawaharlal Institute of Postgraduate Medical
              Education and Research
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 bg-surface rounded-2xl border-l-4 border-primary shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                ...
                is standardized across Indian medical universities to ensure
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Top Medical Universities in India
            </div>
            <div className="h-1.5 w-20 bg-accent rounded-full mx-auto mb-6"></div>
            <p className="text-text-muted max-w-2xl mx-auto">
              Explore other premier medical institutions in India recognized for
              their academic excellence and global clinical standards.
            </p>
          </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Jawaharlal Institute of Postgraduate Medical Education and
              Research
            </div>
...
export default JawaharlalInstituteOfPostgraduateMedicalEducationAndResearch;
