...
const MurmanskArcticUniversity = () => {
          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Murmansk Arctic University</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Murmansk Arctic State University (MASU), established in 1939, is
              one of the northernmost universities globally and the oldest in
              Russia's Arctic region. In 2023, MASU merged with Murmansk State
              Technical University (founded in 1950), forming Murmansk Arctic
              University (MAU), a flagship institution dedicated to Arctic
              research and education. MASU offers a diverse range of programs,
              including marine activities, engineering, IT, medicine, Arctic
              bioresources, and energy sectors. All programs are state-certified
              and closely aligned with industry needs, with partnerships
              involving major companies like Gazprom, Rosneft, and Nornickel.
              The university emphasizes practical training and research,
              particularly in Arctic marine technologies, innovative mining, and
              biotechnology.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={murmanskarcticuniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Murmansk Arctic University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Murmansk Arctic University is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Murmansk Arctic University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Murmansk Arctic University is recognized as one of
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Murmansk Arctic University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Murmansk Arctic University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Murmansk Arctic University library is a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Murmansk Arctic University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Murmansk Arctic University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Murmansk Arctic University
            </div>
...
export default MurmanskArcticUniversity;
