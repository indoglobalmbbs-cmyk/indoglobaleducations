...
const LobachevskyStateUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              N.I. Lobachevsky State University of Nizhni Novgorod (UNN) was
              established in 1916 as a People’s University. The University has
              provided the basis for the development of higher education and a
              fundamental research system in the Nizhni Novgorod region. It is
              one of the best classical universities in Russia. The University
              is renowned for innovation in the fields of research and higher
              education. As a result, UNN’s scientific and pedagogical schools
              have won international recognition for their excellence. The
              continual development of these schools ensures the high standard
              of UNN’s educational activity as a research university. The
              University aims to respond in an effective manner to new and
              evolving scientific and educational challenges. The University has
              concentrated its research efforts through the creation of large
              research institutes that focus on work in cutting-edge fields.
              Additionally, UNN’s scientific and educational cooperation with
              the Russian Academy of Sciences has been formalized. The
              University also continuously engages in multifaceted interaction
              with various branches of the economy.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={lobachevskystateuniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Lobachevsky State University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Lobachevsky State University is a leading institution for
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Lobachevsky State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Lobachevsky State University
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Lobachevsky State University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Lobachevsky State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Lobachevsky State University
            </div>
...
export default LobachevskyStateUniversity;
