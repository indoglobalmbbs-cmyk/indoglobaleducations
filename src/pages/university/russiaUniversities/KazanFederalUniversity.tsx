          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Kazan Federal University</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Founded in 1804, Kazan Federal University is one of the oldest
              universities in Russia. The University actively participates in
              local and international cooperation, networking with academia and
              industry, boosting the region’s human resources development as
              well as top-level research and innovation in different areas. In
              recent years, the university has come up with 17 centers of
              excellence, and 80 world-class research and teaching laboratories.
              Till now, 44,350 students have graduated from this University.
              Presently, Kazan Federal University has 200+ Indian students
              studying MBBS in Russia. There are 590 degree programs in various
              disciplines out of which 17 courses are double-degree programs
              with the partner Universities. The University staff invites 157
              professors from world-renowned Universities and research centers.
              There are 13 institutes, 3 higher schools, 1 faculty, 2 regional
              branches in Yelabuga and NaberezhnteChelny.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={kazanfederaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Kazan Federal University is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Kazan Federal University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Kazan Federal University is recognized as one of
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Kazan Federal University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Kazan Federal University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Kazan Federal University library is a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Kazan Federal University provides a comfortable and secure
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Kazan Federal University
            </div>
