...
const IvanovoStateMedicalAcademy = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Ivanovo State Medical Academy Ivanovo State Medical Academy has
              been training international students from 1991; from this time 256
              foreign citizens were awarded the degree of Doctor of Medicine,
              M.D. in specialties “General Medicine” and “Pediatrics”; one of
              them (a Nepalese graduate, Dr. KRISHNA BHANDARI) was awarded the
              MD Diploma with honor; 22 foreign alumnae maintained their PhD
              dissertations. Now more than 150 international students from 28
              countries: Angola, Afghanistan, Bangladesh, Vietnam, Yemen,
              Jordan, Iraq, Cameroon, Congo, Cote d’Ivoire, Mongolia, Nepal,
              Palestine, Romania, Syria, Somali, Sudan and some states of the
              CIS and former USSR republics are trained at the ISMA. The most
              part of the ISMA alumnae work in large hospitals of Europe, Asia,
              Africa and America. Academy’s buildings and clinics including
              fundamental library with media library are provided with
              up-to-date equipment.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={ivanovostatemedicalacademy}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Ivanovo State Medical Academy
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Ivanovo State Medical Academy is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Ivanovo State Medical Academy has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Ivanovo State Medical Academy is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Ivanovo State Medical Academy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Ivanovo State Medical Academy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Ivanovo State Medical Academy library
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Ivanovo State Medical Academy provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Ivanovo State Medical Academy
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Ivanovo State Medical Academy
            </div>
...
export default IvanovoStateMedicalAcademy;
