...
const SevastopolStateUniversity = () => {
          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Sevastopol State University</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Sevastopol State University is a prestigious university in
              Sevastopol, Russia, offering high-class education in a variety of
              subjects, including MBBS programs in Sevastopol State. Sevastopol
              State University is famous for its modern infrastructure,
              experienced faculty, and research-oriented courses, and thus a
              desired university for students wishing to study MBBS in
              Sevastopol State University. Recognized by renowned medical
              councils such as National Medical Commission (NMC) and World
              Health Organization (WHO), Sevastopol State University ensures
              students receive universally recognized medical degrees.
              Sevastopol State University values a hands-on educational format,
              providing students with hands-on training in modern hospitals,
              with an opportunity for them to gain real-life practice in
              medicine. One of the most significant strengths of MMBS admission
              in Sevastopol State University is its relatively cheap fee
              structure in comparison with most Western nations, and therefore,
              it proves to be a preferred choice for students abroad.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={sevastopolstateuniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Sevastopol State University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Sevastopol State University is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Sevastopol State University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Sevastopol State University is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Sevastopol State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Sevastopol State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Sevastopol State University library is
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Sevastopol State University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Sevastopol State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Sevastopol State University
            </div>
...
export default SevastopolStateUniversity;
