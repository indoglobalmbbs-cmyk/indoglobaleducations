        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Ingush State University stands as a beacon of medical excellence in Russia.
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Ingush State University is a leading institution for medical education in
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Ingush State University has played a pivotal role in the advancement of
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Ingush State University is recognized as one of the largest
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Ingush State University library is a cornerstone of
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Ingush State University provides a comfortable and secure living environment
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <div className="text-3xl md:text-4xl font-bold mb-6">
                Why Choose <span className="text-accent">Ingush State University</span> for
                MBBS in Russia?
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
                The <span className="text-accent">Ingush State University</span> Advantage
              </div>
