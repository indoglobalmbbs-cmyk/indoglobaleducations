...
const DagestanStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Dagestan State Medical University was founded in 1932. This
              University is situated in the Makhachkala City which is the
              capital of Dagestan Republic. Makhachkala City is a very
              well-built and picturesque modern city. Since the University has
              started, it has trained over 25,000 specialists, 100 doctors of
              Sciences and 350 candidates of Science. The students who graduated
              from here are now scientists, organizers of health protection and
              are working in different countries. At present, there are 5200
              students in Dagestan State Medical University out of which 170
              students are international students from 12 countries. There are 6
              specialization courses in the University. The students are
              provided with both undergraduate and postgraduate courses. Over 83
              years, this medical University has become a real school of
              medicine.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={dagestanstatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Dagestan State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Dagestan State Medical University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Dagestan State Medical University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Dagestan State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Dagestan State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Dagestan State Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Dagestan State Medical University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Dagestan State Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Dagestan State Medical University
            </div>
...
export default DagestanStateMedicalUniversity;
