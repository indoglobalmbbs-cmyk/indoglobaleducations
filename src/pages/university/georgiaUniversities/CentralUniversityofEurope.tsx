...
const CentralUniversityofEurope = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Central University of Europe is the first private higher
              educational institution in Western Georgia, which was founded in
              1991. Central University of Europe offers students high-quality,
              international standards-compliant education, various exchange
              programs and practice-oriented teaching. University implements
              educational programs of all three levels. The university has
              faculties of medicine and social sciences, business and law,
              within which both Georgian and English educational programs are
              implemented. A research institute of economics is established at
              the university and the international journal "Economic Profile" is
              published. Central University of Europe is an individual associate
              member of EUA (European Universities Association). It is the fifth
              private university in Georgia to join the European University
              Association, which is a unique opportunity to be involved in the
              process of developing European educational policy.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={centraluniversityofeurope}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Central University of Europe
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Central University of Europe is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Central University of Europe has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Central University of Europe is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Central University of Europe
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Central University of Europe
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Central University of Europe library is
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Central University of Europe provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Central University of Europe
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Central University of Europe
            </div>
...
export default CentralUniversityofEurope;
