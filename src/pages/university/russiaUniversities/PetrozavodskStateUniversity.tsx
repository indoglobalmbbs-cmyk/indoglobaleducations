...
const PetrozavodskStateUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Petrozavodsk State Medical University Russia was established in
              1940. Petrozavodsk State University is a higher education
              institution which is located in the city of Petrozavodsk, Karelia
              Republic-Russia. Petrozavodsk State Medical University is
              recognized by Medical Council of India (MCI) and the Ministry of
              Education and Science of the Russian Federation, Petrozavodsk
              State University most famous and the large coeducational higher
              education institution in Russia. Petrozavodsk State University
              Russia offers bachelor courses and master. Petrozavodsk State
              University includes 12 faculties, 89 departments, 8 educational
              institutes, 84 laboratories,27 innovative departments .
              Petrozavodsk State Medical University Russia have famous teaching
              staff is about more than 600 teachers and professors, 529
              Candidate of Sciences and Associate Professors, 139Doctors of
              Science, and 90 Professors. In Petrozavodsk State Medical study
              more than 16000 undergraduate and postgraduate students from many
              countries. MBBS fees structure is very low in Petrozavodsk State
              Medical University MBBS admission in Russia.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={petrozavodskstateuniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Petrozavodsk State University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Petrozavodsk State University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Petrozavodsk State University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Petrozavodsk State University is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Petrozavodsk State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Petrozavodsk State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Petrozavodsk State University library
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Petrozavodsk State University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Petrozavodsk State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Petrozavodsk State University
            </div>
...
export default PetrozavodskStateUniversity;
