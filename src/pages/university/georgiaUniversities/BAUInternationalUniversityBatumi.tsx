...
const BAUInternationalUniversityBatumi = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              BAU International University Batumi was founded in 2015. Batumi is
              a new premier university in Georgia offering high-quality
              education to local citizens or foreign students who come from
              other countries to study MBBS at BAU International University.
              Over 5,000+ international students are studying here. Candidates
              get a chance to learn from a world-class medical program with
              modern technology. University provides a medical program for 6
              years. The whole medical course is divided into 12 semesters.
              Therefore, BAU International is the best choice to Study MBBS in
              Georgia. MBBS in Georgia is a six-year program taught by seasoned
              faculty members specializing in their specialties and bringing
              real-world experience to the classroom. The institution offers a
              contemporary and well-equipped learning environment that blends
              academic knowledge with practical skills to help students prepare
              for successful medical careers.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={bauinternationaluniversitybatumi}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                BAU International University Batumi is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  BAU International University Batumi has played a pivotal role
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, BAU International University Batumi is recognized
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for BAU International University Batumi
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for BAU International University Batumi
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the BAU International University Batumi
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                BAU International University Batumi provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at BAU International University Batumi
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at BAU International University Batumi
            </div>
...
export default BAUInternationalUniversityBatumi;
