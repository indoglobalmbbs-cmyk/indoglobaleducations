...
const IMSechenovFirstMoscowStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              ...
              University) is considered as one of the Top Medical Universities
              in Russia. University had begun its history in 1758 as the medical
              faculty at Imperial Moscow University. Sechenov University has
              been a pioneer in the Russian Healthcare System. Many renowned
              scientists and physicians have already worked at the University,
              who are known for their significant contributions to the progress
              of medicine. Today, the University has grown up into an academic,
              research, and Resource Centre of Excellence in the Russian
              Healthcare System. It enforces the development of Medicine of the
              Future, based on a strong academic foundation in clinical
              medicine, expanding frontiers in advanced multidisciplinary
              research.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={imsechenovfirstmoscowstatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                I. M. Sechenov First Moscow State Medical University is a
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  I. M. Sechenov First Moscow State Medical University has
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, I. M. Sechenov First Moscow State Medical
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for I. M. Sechenov First Moscow State Medical
              University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for I. M. Sechenov First Moscow State Medical
              University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the I. M. Sechenov First Moscow State
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                I. M. Sechenov First Moscow State Medical University provides a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at I. M. Sechenov First Moscow State Medical
              University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at I. M. Sechenov First Moscow State Medical University
            </div>
...
export default IMSechenovFirstMoscowStateMedicalUniversity;
