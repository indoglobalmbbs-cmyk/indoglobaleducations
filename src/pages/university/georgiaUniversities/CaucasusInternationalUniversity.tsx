        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Caucasus International University is an accredited Higher
              Educational Institute, established in 1998. Formerly it was known
              as LLC Caucasus International University and granted International
              Quality Accreditation by the Central and Eastern European
              Management Development Association (CEEMAN) and also registered
              under MCI. The university’s curriculum also includes extensive
              participation of students in international programs and
              conferences to give them the exposure of the real world problems.
              Many professional experience programs and exchange programs were
              offered with engaging teaching methods for the students. The
              programs are delivered by internationally qualified lecturers and
              specialists providing quality education which prepares the
              students as highly-qualified specialists in various spheres.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={caucasusinternationaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Caucasus International University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Caucasus International University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Caucasus International University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Caucasus International University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Caucasus International University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Caucasus International University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Caucasus International University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Caucasus International University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Caucasus International University
            </div>
