...
const UniversityofMedicineandPharmacyofCraiova = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Lucian Blaga University, also known as, “Lucian Blaga” University
              of Sibiu-ULBS, is a 225 years old university in Romania. The
              university is well-known for its courses in international
              languages and modern technology in imparting education to its
              students. With significant partnerships, research facilities, and
              constant innovation, Lucian Blaga University strives for
              excellence and quality education. The university has a 6-year
              medical course offered in English and Romanian. Several students
              from all over the world seek admission to Lucian Blaga University
              to study medicine due to the exemplary facilities that they
              provide.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={universityofmedicineandpharmacyofcraiova}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About University of Medicine and Pharmacy of Craiova
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                University of Medicine and Pharmacy of Craiova is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  University of Medicine and Pharmacy of Craiova has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, University of Medicine and Pharmacy of Craiova is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for University of Medicine and Pharmacy of Craiova
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for University of Medicine and Pharmacy of Craiova
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the University of Medicine and Pharmacy of Craiova
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                University of Medicine and Pharmacy of Craiova provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at University of Medicine and Pharmacy of Craiova
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at University of Medicine and Pharmacy of Craiova
            </div>
...
export default UniversityofMedicineandPharmacyofCraiova;
