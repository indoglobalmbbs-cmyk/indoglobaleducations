...
const VolgogradStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Established in 1935, Volgograd State Medical University is one of
              the most famous and highly reputable Higher Schools both in Russia
              and abroad. It is proud of its highly-qualified teaching staff,
              advanced researchers and experienced physicians whose names are
              world-famous. The university has become a common choice for the
              Indian students seeking MBBS in Russia. The University is
              accredited by the Russian Ministry for Education for the teaching
              of both Russian and overseas students. The university is also
              listed by World Directory Of Medical Schools (WDOMS), Educational
              Commission for Foreign Medical Graduates (ECFMG), Foundation for
              Advancement of International Medical Education and Research
              (FAIMER), World Federation for Medical Education (WFME), erstwhile
          ...
          <div className="md:w-1/2">
            <img
              src={volgogradstatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Volgograd State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Volgograd State Medical University has played a pivotal role
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Volgograd State Medical University is recognized
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Volgograd State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Volgograd State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Volgograd State Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Volgograd State Medical University provides a comfortable and
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Volgograd State Medical University
            </div>
...
export default VolgogradStateMedicalUniversity;
