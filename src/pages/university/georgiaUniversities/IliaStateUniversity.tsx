          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Ilia State University</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              ILIA State University Georgia welcomes around 5,000+ fresh
              students every year at the level of higher education. This
              university has become the most demanding university in Georgia.
              Students come from around 15 countries to study MBBS in Georgia.
              It got approval from world’s popular medical organizations like
              National Medical Commission (NMC), the World Health Organization
              (WHO), etc. At the time, ILIA University Georgia had over 16,000
              students. This university has 800 academic staff, 275 professors,
              and more than 1,000+ researchers and teachers. ILIA State
              University has 30 research institutes and centres. Besides, this
              university is listed among the top medical universities in
              Georgia. ILIA State University was founded in 2006 as a result of
              a merger of six different academic institutions with long and
              diverse histories.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={iliastateuniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Ilia State University is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Ilia State University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Ilia State University is recognized as one of the
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Ilia State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Ilia State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Ilia State University library is a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Ilia State University provides a comfortable and secure living
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Ilia State University
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <div className="text-3xl md:text-4xl font-bold mb-6">
                Why Choose{' '}
                <span className="text-accent">Ilia State University</span> for
                MBBS in Georgia?
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
                The <span className="text-accent">Ilia State University</span>{' '}
                Advantage
              </div>
...
export default IliaStateUniversity;
