...
const NPOgarevMordoviaStateUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              N.P.Ogarev Mordovia State University now boasting a status of a
              National research university is a Federal state budgetary academic
              institution of higher education offering the whole spectrum of
              academic programmes for undergraduate, graduate and post graduate
              students; among its core activity is fundamental and applied
              research, further training and qualification improvement courses
              for teaching staff and scholars. It is the major higher education
              institution in the Republic. By the Federal government edict dated
              of 20th May 2010 Ogarev Mordovia State University was conferred a
              category “National research university”. Founded in 1931 as the
              Agronomy Pedagogical Institute it gradually expanded and granted
              the University status in 1957. Its appearance was a milestone in
              the evolution of quality education in the Republic of Mordovia.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={npogarevmordoviastateuniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About N. P. Ogarev Mordovia State University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                N. P. Ogarev Mordovia State University is a leading institution
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  N. P. Ogarev Mordovia State University has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, N. P. Ogarev Mordovia State University is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for N. P. Ogarev Mordovia State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for N. P. Ogarev Mordovia State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the N. P. Ogarev Mordovia State University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                N. P. Ogarev Mordovia State University provides a comfortable
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at N. P. Ogarev Mordovia State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at N. P. Ogarev Mordovia State University
            </div>
...
export default NPOgarevMordoviaStateUniversity;
