          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Ryazan State University</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Ryazan State University was founded in the year 1950 and named
              after I.P. Pavlov. Born in Ryazan, he became the first Nobel
              Laureate for medicine. Ryazan State University is considered to be
              one of the most renowned medical universities in Russia that has
              earned a very high reputation ever since its establishment. The
              University strongly collaborates with the international
              educational as well as organizations like the American
              Pharmaceutical Convention and Medical University of Arizona much
              more. International Awards such as American Golden Certificate for
              the International Prestige (Monte-Carlo), The Crystal Knight
              (Malta), Golden Lion (South Africa), Havana Libre Cup from 21st
              century (Euro Union Organization) are some of the collection of
              the University’s awards. In 2004, a European Quality Diploma was
              received by the University. At present, there are around 5000
              students from 45 regions of Russia and 40 countries studying
              medicine from this prestigious university. More than 17,000
              doctors graduated from this University having an international
              reputation in Russia and abroad.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={ryazanstateuniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Ryazan State University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Ryazan State University is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Ryazan State University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Ryazan State University is recognized as one of
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Ryazan State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Ryazan State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Ryazan State University library is a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Ryazan State University provides a comfortable and secure living
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Ryazan State University
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <div className="text-3xl md:text-4xl font-bold mb-6">
                Why Choose{' '}
                <span className="text-accent">Ryazan State University</span> for
                MBBS in Russia?
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
                The <span className="text-accent">Ryazan State University</span>{' '}
                Advantage
              </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Ryazan State University
            </div>
