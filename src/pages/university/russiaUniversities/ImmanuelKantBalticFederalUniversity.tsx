        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Immanuel Kant Baltic Federal University was founded in 1967
              expanding on the already existing Kaliningrad State Pedagogical
              University that had been founded in 1947. The history of the
              University began with the establishment of the State Pedagogical
              Institute in Kaliningrad. IKBFU is a leading university of the
              Kaliningrad region and one of the ten federal universities of the
              Russian Federation. Conveniently located in the heart of Europe,
              Immanuel Kant Baltic Federal University attracts students and
              researchers from around the world. Today citizens from 40
              countries of the world – from Europe, Latin America, Asia and
              Africa – study at different levels and conduct research at the
              University. Immanuel Kant Baltic Federal University carefully
              keeps the academic traditions of its predecessor – the ‘Albertina’
              University of Königsberg and introduces the newest technologies of
              Russian classical education.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={immanuelkantbalticfederaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Immanuel Kant Baltic Federal University is a leading institution
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Immanuel Kant Baltic Federal University has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Immanuel Kant Baltic Federal University is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Immanuel Kant Baltic Federal University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Immanuel Kant Baltic Federal University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Immanuel Kant Baltic Federal University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Immanuel Kant Baltic Federal University provides a comfortable
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Immanuel Kant Baltic Federal University
            </div>
