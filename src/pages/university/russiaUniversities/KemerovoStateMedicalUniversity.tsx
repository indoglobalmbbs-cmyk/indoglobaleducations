...
const KemerovoStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Kemerovo State Medical University (KSMU) of the Ministry of Health
              of Russia, is a public medical education institution in Kemerovo,
              Russia. Established in 1956, the university is renowned for its
              exceptional medical education and training programs. The
              university is recognized at the Russian and international levels
              and also confirmed by the independent professional community and
              international expert organizations. The Ministry of Health of the
              Russian Federation approves the MBBS degree from Kemerovo State
              Medical University. It is also recognized by other medical
              institutions such as the National Medical Commission (NMC),
              enlisted with the World Directory of Medical Schools (WDOMS), and
              more, including ECFMG, FAIMER, etc. Kemerovo State Medical
              University of the Russian Ministry of Health offers a wide range
              of educational programs. Currently, the university has a unique
              teaching staff, of which 78% have academic degrees of candidates
              and doctors of science.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={kemerovostatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Kemerovo State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Kemerovo State Medical University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Kemerovo State Medical University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Kemerovo State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Kemerovo State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Kemerovo State Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Kemerovo State Medical University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Kemerovo State Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Kemerovo State Medical University
            </div>
...
export default KemerovoStateMedicalUniversity;
