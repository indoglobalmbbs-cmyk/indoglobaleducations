...
const KubanStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              The Kuban State Medical University was founded in 1920 by the
              Government of the Russian Federation and to date, it is considered
              as one of the ancient Universities of Kuban and one of the Top
              Medical Universities of Russia. The authority of the founder is
              supervised by the Ministry of Health of the Russian Federation.
              The university occupies a special place in the structure of higher
              professional education in Russia thanks to the quality management
              system of vocational education. Kuban State Medical University is
              among the 5 premier Universities of Russia that work with
              biological materials. The University has a renowned name for
              medical education among international students, especially Indian
              students- to pursue MBBS in Russia. The Center for Practical
              Skills was created with the aim of solving fundamentally important
              issues of medical education; to master the skills of a doctor
              without causing harm to the patients. KSMU provides training in
              the field of medicine, pharmacy, which is conducted by
              highly-qualified specialists.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={kubanstatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Kuban State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Kuban State Medical University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Kuban State Medical University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Kuban State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Kuban State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Kuban State Medical University library
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Kuban State Medical University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Kuban State Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Kuban State Medical University
            </div>
...
export default KubanStateMedicalUniversity;
