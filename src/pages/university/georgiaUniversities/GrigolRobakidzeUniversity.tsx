          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Grigol Robakidze University</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Grigol Robakidze University was founded in 1992 to deliver medical
              education in Georgia. It’s located in Tbilisi City, the capital of
              Georgia. In this over 30 years of history. This university is
              among the top medical universities in the country. This university
              has trained over 1000+ students in the medical field. It is
              popular as the most demanding destination among all medical
              aspirants across the world. There are thousands of medical
              students who come to study MBBS from every corner of the world.
              Grigol Robakidze University is one of the higher medical
              institutes in the country. It has a highly qualified medical
              faculty that aims to provide the best quality medical education to
              international students. Apart from that, Candidates get more
              facilities along with their studies. It is the best university to
              Study MBBS Abroad.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={grigolrobakidzeuniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Grigol Robakidze University is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Grigol Robakidze University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Grigol Robakidze University is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Grigol Robakidze University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Grigol Robakidze University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Grigol Robakidze University library is
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Grigol Robakidze University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Grigol Robakidze University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Grigol Robakidze University
            </div>
