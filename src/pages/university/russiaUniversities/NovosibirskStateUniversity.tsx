...
const NovosibirskStateUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Novosibirsk State University (NSU) is a public research university
              located in Novosibirsk, Russia. The university was founded in
              1958, on the principles of integration of education and science,
              early involvement of students with research activities and the
              engagement of leading scientists in its teaching programmes. From
              the perspective of natural resources, Siberia has always been, and
              remains, the essential region for all of Russia. In the late
              1950s, Siberia provided the country with 75% of its coal and
              possessed 80% of the nation's hydroelectric resources. Siberia
              became industrialized, but science then was largely of the applied
              variety and did not satisfy its needs. The USSR Academy of
              Sciences came to understand that there was a need to develop
              fundamental science. In 1958, this concept was implemented with
              the establishment of the Siberian Branch of the Academy of
              Sciences of the Soviet Union at Akademgorodok, near the industrial
              city of Novosibirsk.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={novosibirskstateuniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Novosibirsk State University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Novosibirsk State University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Novosibirsk State University is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Novosibirsk State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Novosibirsk State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Novosibirsk State University library is
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Novosibirsk State University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Novosibirsk State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Novosibirsk State University
            </div>
...
export default NovosibirskStateUniversity;
