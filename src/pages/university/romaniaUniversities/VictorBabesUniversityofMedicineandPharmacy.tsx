...
const VictorBabesUniversityofMedicineandPharmacy = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              ...
              was first founded as a modest faculty, part of the initial Western
              University, following the Decree-Law No. 660, issued and signed by
              His Majesty King Michael I of Romania, on 30th December 1944; the
              inauguration of the new faculty took place on 15 July 1945. The
              first document, which recorded the establishment of The Timisoara
              Faculty of Medicine, was the Decree no. 104 on 17th January 1945,
              signed by the Ministry of Health, Dr. Dumitru Bagdasar, a
              prominent personality of the Romanian medical life. However, the
              fundamental document, which led, de jure et de facto, to the
              setting up of the Faculty of Medicine, was the Law no.361 of May,
              4th, 1945, modifying the provisions of Council Order by which the
              Western University was set up, so as to meet the objective
              requirements for the formation of healthcare specialists, in the
              West of the country.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={victorbabesuniversityofmedicineandpharmacy}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Victor Babes University of Medicine and Pharmacy
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Victor Babes University of Medicine and Pharmacy is a leading institution for
                medical education in Romania, offering a globally recognized MD
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Victor Babes University of Medicine and Pharmacy has played a pivotal role in
                  the advancement of medical sciences and the education of
                  medical professionals. Consistently ranked among the{' '}
                  <strong>top 10 medical institutes in Romania</strong>, it
                  stands out in the yearly official ratings among the 48
                  Romanian Institutes of Medical Education.
                </p>
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Victor Babes University of Medicine and Pharmacy is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Victor Babes University of Medicine and Pharmacy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Victor Babes University of Medicine and Pharmacy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Victor Babes University of Medicine and Pharmacy
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Victor Babes University of Medicine and Pharmacy provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Victor Babes University of Medicine and Pharmacy
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Victor Babes University of Medicine and Pharmacy
            </div>
...
export default VictorBabesUniversityofMedicineandPharmacy;
