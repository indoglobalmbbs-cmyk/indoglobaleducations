          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">University of Oradea</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              With established international relations with 352 institutions
              across 39 countries, Oradea University in Oradea, Romania, strives
              to provide the best to its students. Founded in the 1700’s, the
              university has added several faculties as a part of their courses.
              Ranging from huge amphitheaters to the university library which
              has the most modern features, students get access to 15 faculties
              in the graduate and post-graduate fields of study. The faculty of
              medicine and Pharmacy at Oradea University is headed by
              distinguished experts who guide students with studies, training,
              as well as internships at the University Clinic as well as other
              hospitals that are affiliated with the university. The institute
              also provides recreational facilities in the form of dendrological
              parks that house many species, luxury accommodations, canteens,
              cafes, and a sports base.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={universityoforadea}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About University of Oradea
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                University of Oradea is a leading institution for medical
                education in Romania, offering a globally recognized MD program.
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  University of Oradea has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, University of Oradea is recognized as one of the
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for University of Oradea
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for University of Oradea
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the University of Oradea library is a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                University of Oradea provides a comfortable and secure living
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at University of Oradea
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <div className="text-3xl md:text-4xl font-bold mb-6">
                Why Choose{' '}
                <span className="text-accent">University of Oradea</span> for
                MBBS in Romania?
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
                The <span className="text-accent">University of Oradea</span>{' '}
                Advantage
              </div>
...
export default UniversityofOradea;
