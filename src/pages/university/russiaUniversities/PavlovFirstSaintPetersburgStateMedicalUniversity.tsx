...
const PavlovFirstSaintPetersburgStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Pavlov First Saint- Petersburg State Medical University was
              established in September, 1897. Initially, it was introduced as
              the Medical Institute for Women. This institution is considered to
              be the first institution to provide an opportunity for women to
              obtain higher medical education. The name St. Petersburg State
              I.P. Pavlov Medical University was given by the Government of the
              Russian Federation in the year 1994. The University believes in
              adapting a unique teaching methodology which is based on the
              combination of the best Russian Medical Educational Traditions
              with the methods of Western Education System. The University is
              the only higher medical school which has a polyclinic within the
              boundaries of the University. In the year 2017, it celebrated the
              192nd anniversary of the founding of the polyclinic. This
              University is recognized as a big center for training specialists
              all over the world.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={pavlovfirstsaintpetersburgstatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Pavlov First Saint Petersburg State Medical University is a
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Pavlov First Saint Petersburg State Medical University has
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Pavlov First Saint Petersburg State Medical
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Pavlov First Saint Petersburg State Medical
              University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Pavlov First Saint Petersburg State Medical
              University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Pavlov First Saint Petersburg State
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Pavlov First Saint Petersburg State Medical University provides
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Pavlov First Saint Petersburg State Medical
              University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Pavlov First Saint Petersburg State Medical University
            </div>
...
export default PavlovFirstSaintPetersburgStateMedicalUniversity;
