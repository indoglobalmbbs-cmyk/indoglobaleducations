        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Ken Walker International University (KWIU), situated in the
              capital city of Tbilisi, Georgia, has become a preferred choice
              for medical students ever since its creation in 2019. KWIU is one
              of the most reputed universities in medical education, owing to
              the fact that it was established through the collaboration of
              Emory University School of Medicine (USA). The university mainly
              offers its six-year program that confers a title of 'Medical
              Doctor (MD)' equivalent to the degree of 'MBBS', which is
              conducted entirely in the English language. The program consists
              of five years of theoretical learning as well as hands-on training
              before one spends a year in practical work known as an internship.
              Rank-wise, KWIU ranks among the top universities of Georgia on
              account of its contemporary facilities and American-style
              curriculum. It boasts important certifications, including WFME,
              WHO and NMC.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={kenwalkerinternationaluniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Ken Walker International University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Ken Walker International University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Ken Walker International University has played a pivotal role
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Ken Walker International University is recognized
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Ken Walker International University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Ken Walker International University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Ken Walker International University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Ken Walker International University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Ken Walker International University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Ken Walker International University
            </div>
