...
const AlFarabiKazakhNationalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Al-Farabi Kazakh National University, also known as KazNU, is one
              of the largest and oldest universities in Kazakhstan, named after
              the country's renowned philosopher and scholar, AL-FARABI,
              established in 1934. Originally founded to provide medical
              education to students, KazNU has evolved into a classical
              university, offering a broad range of academic programs. Following
              Kazakhstan's declaration of independence in 1990, the university's
              name was changed to Al-Farabi Kazakh State University. With its
              international standard of education and emphasis on practical
              studies, KazNU offers many advantages to international students,
              making it an attractive destination for many Indian students. This
              approach helps students to enhance their medical abilities and
              gain valuable hands-on experience in addition to theoretical
              knowledge.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={alfarabikazakhnationaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Al-Farabi Kazakh National University is a leading institution
                for medical education in Kazakhstan, offering a globally
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Al-Farabi Kazakh National University has played a pivotal role
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Al-Farabi Kazakh National University is recognized
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Al-Farabi Kazakh National University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Al-Farabi Kazakh National University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Al-Farabi Kazakh National University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Al-Farabi Kazakh National University provides a comfortable and
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Al-Farabi Kazakh National University
            </div>
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              Explore other premier medical institutions in Kazakhstan recognized
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Al-Farabi Kazakh National University
            </div>
...
export default AlFarabiKazakhNationalUniversity;
