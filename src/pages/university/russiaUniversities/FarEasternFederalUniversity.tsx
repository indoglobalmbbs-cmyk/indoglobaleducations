...
const FarEasternFederalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Far Eastern Federal University was founded in the year 1899 at
              Vladivostok in Eastern Russia. Vladivostok is also known as
              Russia’s San Francisco and this is the administrative centre of
              Primorsky Krai. Far Eastern Federal University is considered to be
              one of the top Universities selected by the Russian Ministry of
              Education and Science. It helps in enhancing the international
              competitiveness of Russian Universities among the world’s leading
              research and education centres. With over 200 highly skilled and
              specialized staff, the university’s Medical Centre provides
              special medical facilities to their patients. These specialized
              doctors have been invited to other parts of Russia as well as to
              other countries. Far Eastern Federal University has been the flag
              bearer of the high tech education system. Its medical equipment
              has been produced by the leaders of the medical industry with high
              tech medical assistance.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={fareasternfederaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Far Eastern Federal University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Far Eastern Federal University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Far Eastern Federal University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Far Eastern Federal University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Far Eastern Federal University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Far Eastern Federal University library
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Far Eastern Federal University provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Far Eastern Federal University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Far Eastern Federal University
            </div>
...
export default FarEasternFederalUniversity;
