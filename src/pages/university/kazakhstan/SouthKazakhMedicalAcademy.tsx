...
const SouthKazakhMedicalAcademy = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              South Kazakhstan Medical Academy (SKMA) is a well–known public
              university situated in Shymkent, the third largest city in
              Kazakhstan. Incorporated in 1979 as a Shymkent State
              Medical Institute (SSMI), the university is today one of
              Kazakhstan’s leading medical and pharmaceutical education hubs
              with a modern training-medical centre and partnerships with more
              than 12 international universities worldwide. SKMA provides MBBS,
              Dentistry, Pharmacy, and other programs to global students in a
              conducive environment under qualified teachers.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={southkazakhmedicalacademy}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About South Kazakh Medical Academy
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                South Kazakh Medical Academy is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  South Kazakh Medical Academy has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, South Kazakh Medical Academy is recognized as one
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for South Kazakh Medical Academy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for South Kazakh Medical Academy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the South Kazakh Medical Academy library is
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                South Kazakh Medical Academy provides a comfortable and secure
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at South Kazakh Medical Academy
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at South Kazakh Medical Academy
            </div>
...
export default SouthKazakhMedicalAcademy;
