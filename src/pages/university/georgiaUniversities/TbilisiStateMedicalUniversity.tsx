        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Tbilisi State Medical University was founded in 1918. It is one of
              the largest medical universities in Georgia which is officially
              recognized by WHO, MCI, Educational Commission for Foreign Medical
              Graduates (ECFMG), World Federation of Medical Education and
              European Commission for Education. The university is 8th ranked
              among the higher-education institution in Georgia. Every year
              large number of students take admission in the university;
              presently there are around 7000+ undergraduate and 3000 post
              graduates in which almost 25% are foreign students. The University
              provides a wide range of diplomatic, graduate and post-graduate
              courses with worldwide recognized degrees. The university also
              offers opportunities for self-development to equip knowledge and
              skills necessary. It focuses on continuous improvement in
              teaching, learning, and research & management quality. It has
              modern infrastructure and healthy environment which promotes
              learning, development and active participation of students.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={tbiliststatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Tbilisi State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Tbilisi State Medical University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Tbilisi State Medical University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Tbilisi State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Tbilisi State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Tbilisi State Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Tbilisi State Medical University provides a comfortable and
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Tbilisi State Medical University
            </div>
