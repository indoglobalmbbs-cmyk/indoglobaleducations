...
const PrivolzhskyResearchMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              The seats are fewer in comparison to contenders which are a ratio
              of 2:23. Russia provides higher education with an affordable fee
              structure, modern tools, research centres and globally accredited
              degrees. The universities are well-recognized for their
              contributions to medical education, healthcare and research.
              Therefore, MBBS in Russia is an emerging hub for ambitious,
              goal-oriented students. Privolzhsky Research Medical University is
              one of best universities among Russian universities. Established
              in 1920, they offer an extensive range of undergraduate and
              postgraduate courses in MBBS Abroad. The university aims to
              promote cross-cultural, enrich education experience and
              collaborate in research work. To meet goals they have highly
              qualified professors, medical professionals and researchers who
              work to advance knowledge and innovation in healthcare.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={privolzhskyresearchmedicaluniversity}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Privolzhsky Research Medical University
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Privolzhsky Research Medical University is a leading institution
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Privolzhsky Research Medical University has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Privolzhsky Research Medical University is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Privolzhsky Research Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Privolzhsky Research Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Privolzhsky Research Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Privolzhsky Research Medical University provides a comfortable
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Privolzhsky Research Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Privolzhsky Research Medical University
            </div>
...
export default PrivolzhskyResearchMedicalUniversity;
