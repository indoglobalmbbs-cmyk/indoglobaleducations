            ...
            <div className="lg:w-1/2 w-full">
              <div className="relative p-8 bg-primary rounded-3xl overflow-hidden text-white shadow-2xl">
                ...
                <p className="text-blue-100 text-sm mb-6 leading-relaxed relative z-10">
                  Indian medical universities are renowned for their exceptional
                  educational infrastructure. Experienced faculties assist
                  students in medical research endeavors, ensuring that proper
                  research methodologies are emphasized from the very first
                  year.
                </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
              ...
              <p className="text-sm text-blue-100 mb-4">
                The Indian Federation offers full-funded seats covering tuition,
                accommodation, and living stipends for top-tier students.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
              <h3 className="text-xl font-bold text-accent mb-4">
