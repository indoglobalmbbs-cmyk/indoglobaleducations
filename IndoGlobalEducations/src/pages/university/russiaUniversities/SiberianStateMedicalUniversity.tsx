...
const SiberianStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Established in 1878, Siberian State Medical University (SibMed) is
              one of the favored choices among the Indian students studying MBBS
              in Russia. The university has gained the status of the only
              flagship medical university in Russia in 2017. SibMed is one of
              the few institutions in Russia that has its own multidisciplinary
              university hospital. This affects the teaching staff and student
              body to a large extent. The teaching staff consists of 80% of
              specialists with academic degrees and titles and 50% practicing
              doctors. In addition to the multidisciplinary hospital, SibMed
              students can receive training at the modern simulation center,
              which is one of the two centers in the Russian Federation that has
              received accreditation by the European Society for Simulation in
              Medicine (SESAM).
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={siberianstatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Siberian State Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Siberian State Medical University has played a pivotal role in
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Siberian State Medical University is recognized as
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Siberian State Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Siberian State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Siberian State Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Siberian State Medical University provides a comfortable and
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Siberian State Medical University
            </div>
...
export default SiberianStateMedicalUniversity;
