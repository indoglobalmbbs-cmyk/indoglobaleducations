          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">European Medical University</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              EMU or European Medical University was founded in 1993 by Viktor
              Vasyliovych Abramov, a Doctor of Medical Sciences, Professor, an
              Academician of the Academy of Sciences of the Higher School of
              Ukraine. He was the rector of the university until 2017. For his
              activity in the medical education field V.V. Abramov was awarded
              the title of "Excellent Worker in Education of Ukraine", and was
              repeatedly awarded the diplomas of the Ministry of Education and
              Science, Youth and Sports, and Ministry of Labor and Social Policy
              of Ukraine. The chair of complementary and alternative medicine
              was organized by the candidate of medical sciences, associate
              professor Alisa Georgiyivna Krasovskaya under the direction of the
              rector V.V. Abramov.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={europeanmedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                European Medical University is a leading institution for medical
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  European Medical University has played a pivotal role in the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, European Medical University is recognized as one
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the European Medical University library is
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                European Medical University provides a comfortable and secure
