        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Batumi Shota Rustaveli State University is located in Batumi,
              capital of the Autonomous Republic of Adjara. Georgia. This
              University was founded on the basis of Batumi Pedagogical
              Institute and with the advent of time courses in masters and
              bachelors were started. At present, there are around 6,000
              students pursuing various courses in Bachelor, Master and Doctoral
              programs from this University. The university is recognized by
              MCI, WHO, UNESCO etc. Modern teachings methodologies includes
              online learning which is widely used here. Batumi Shota Rustaveli
              State University has maintained close partnership relations with
              the leading higher educational institutions within and outside the
              country. BSRSU is one of the most desirable hosts for organizing
              the international scientific conferences and symposia held in
              various fields of science. The academic and scientific faculty of
              the university actively participate in scientific conferences and
              exchange programs in different universities around the world.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={batumishotarustavelistateuniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Batumi Shota Rustaveli State University is a leading institution
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Batumi Shota Rustaveli State University has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Batumi Shota Rustaveli State University is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Batumi Shota Rustaveli State University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Batumi Shota Rustaveli State University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Batumi Shota Rustaveli State University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Batumi Shota Rustaveli State University provides a comfortable
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Batumi Shota Rustaveli State University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Batumi Shota Rustaveli State University
            </div>
