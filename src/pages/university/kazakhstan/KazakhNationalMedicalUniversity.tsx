...
const KazakhNationalMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Asfendiyarov Kazakh National Medical University (KazNMU) is a
              prestigious institution located in Almaty, Kazakhstan. Founded in
              1930, it is renowned for providing high-quality medical education
              and cutting-edge research opportunities. KazNMU offers a variety
              of medical programs, including MBBS, Dentistry, Pharmacy, and
              Nursing, all conducted by experienced faculty members. The
              university's modern infrastructure and commitment to excellence
              make it a top choice for aspiring medical professionals worldwide.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={kazakhnationalmedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Kazakh National Medical University is a leading institution for
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Kazakh National Medical University has played a pivotal role
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Kazakh National Medical University is recognized
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Kazakh National Medical University
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Kazakh National Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Kazakh National Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Kazakh National Medical University provides a comfortable and
...
export default KazakhNationalMedicalUniversity;
