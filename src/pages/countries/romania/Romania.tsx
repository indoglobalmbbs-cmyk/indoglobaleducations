...
const Romania = () => {
  ...
  const visibleUniversities = showAll
    ? romaniaUniversities
    : romaniaUniversities.slice(0, 6);

  const galleryImages = [
    { src: banner1, title: 'MBBS University Campus in Romania' },
    { src: banner2, title: 'Modern Medical Classrooms Romania' },
    { src: banner3, title: 'Indian Student Life in Romania' },
    { src: banner4, title: 'Clinical Training for MBBS Students' },
    { src: banner5, title: 'Student Hostel Facilities Romania' },
    { src: banner6, title: 'MBBS Graduation Ceremony Romania' },
  ];
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        <img
          src={mbbsRussia}
          alt="Study MBBS in Romania - Indo Global Education"
        ...
        <div className="relative z-10 container mx-auto px-6 text-white">
          ...
          <p className="text-xl max-w-2xl text-gray-200">
            Indo Global Education - MBBS in Romania
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            <div className="text-3xl font-bold text-primary mb-6">
              MBBS in Romania Fee for Indian Students (Updated 2026-27)
            </div>
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-6">
          <div className="mb-10">
            <div className="text-3xl font-bold text-primary mb-4">
              Study MBBS in Romania for Indian Students 2024-25
            </div>
            <div className="h-1.5 w-20 bg-accent rounded-full mb-8"></div>
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-6 text-gray-700 leading-relaxed">
                <p>
                  MBBS in Romania is a popular option for medical students from
                  ...
                  world’s top 100 medical universities, Romania offers excellent
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="text-sm">
                    ...
                    <tr className="border-b border-gray-100 bg-gray-50">
                      ...
                      <td className="p-4 text-gray-600">English & Romanian</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-bold text-primary">
                        Top Ranked Unis
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Many students from India and other countries choose Romania for
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="p-8 bg-primary-light rounded-2xl border-t-4 border-accent">
              ...
              <p className="text-text-muted mb-4">
                The MBBS program in Romania lasts for <strong>6 years</strong>.
              </p>
            ...
            <div className="p-8 bg-primary-light rounded-2xl border-t-4 border-primary">
              ...
              <p className="text-sm text-text-muted italic">
                Support for learning Romanian is provided to help students
      ...
      <section className="py-10 bg-gray-100">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {romaniaUniversities.map((uni, idx) => (
              <div
                key={idx}
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              MBBS in Romania Fees Structure 2024-25
            </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Romanian medical universities offer a blend of high academic
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3">
                  {[
                    'Bilingual medium of instruction (English & Romanian)',
            ...
            <div className="lg:w-1/2 w-full">
              <div className="relative p-8 bg-primary rounded-3xl overflow-hidden text-white shadow-2xl">
                ...
                <p className="text-blue-100 text-sm mb-6 leading-relaxed relative z-10">
                  Romanian medical universities are renowned for their
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl font-bold text-primary mb-4">
              MBBS Syllabus in Romania (6 Years)
            </div>
            <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-10 bg-gray-100">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Comparison: MBBS in Romania vs. MBBS in India
            </div>
            <p className="text-gray-600">
              ...
              <tbody className="text-gray-700">
                ...
                <tr className="border-b border-gray-50">
                  ...
                  <td className="p-5 text-center text-success font-medium">
                    Highly subsidized by the Romanian Government.
                  </td>
                  <td className="p-5 text-center">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
              ...
              <p className="text-sm text-blue-100 mb-4">
                The Romanian Federation offers full-funded seats covering
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div className="mt-6 p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                  <p className="text-xs text-red-700 font-medium italic">
                    Note: Romanian PG degrees are currently not recognized in
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Romanian Medical Universities
            </div>
            <p className="text-gray-600 max-w-2xl mx-auto">
