...
const NorthWesternStateMedicalUniversity = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              The North-Western State Medical University named after I.I.
              Mechnikov (NWSMU), previously known as St. Petersburg I.I.
              Mechnikov State Medical Academy (SPSMA) until 2011, is a public
              university located in St. Petersburg, Russia. As one of the oldest
              and largest medical institutions in the country, NWSMU is often
              referred to as the Second Medical College in St. Petersburg—a
              title it gained in 1920 following the establishment of Saint
              Petersburg State Medical University, also known as the First
              Medical College. Since its founding, the university has trained
              over 35,000 physicians. Its international program, launched in
              1947, has welcomed more than 3,500 graduates from over 50
              countries. Today, NWSMU has a student population exceeding 5,000.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={northwesternstatemedicaluniversity}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                North Western State Medical University is a leading institution
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  North Western State Medical University has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, North Western State Medical University is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for North Western State Medical University
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the North Western State Medical University
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                North Western State Medical University provides a comfortable
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at North Western State Medical University
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at North Western State Medical University
            </div>
...
export default NorthWesternStateMedicalUniversity;
