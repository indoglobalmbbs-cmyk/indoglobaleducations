          ...
          <div className="md:w-1/2">
            <div className="mb-10 text-left">
              <div className="text-3xl font-bold text-primary mb-4">
                ...
                <span className="text-accent">Orel</span>
              </div>
              <div className="h-1.5 w-20 bg-accent rounded-full"></div>
            </div>
            <p className="mb-6 text-text-muted leading-relaxed">
              Orel stands as a beacon of medical excellence in Russia. Known for
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Orel is a leading institution for medical education in Russia,
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">Orel</div>
            <div className="h-1.5 w-20 bg-accent rounded-full mx-auto md:mx-0 mb-8"></div>
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Orel has played a pivotal role in the advancement of medical
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Orel is recognized as one of the largest centers
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Orel library is a cornerstone of
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Orel provides a comfortable and secure living environment across{' '}
              ...
              <tbody className="text-text">
                {[
                  ...
                  [
                    ...
                    'Orel',
                    'Nizhny Orel Medical University',
                  ],
                  [
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <div className="text-3xl md:text-4xl font-bold mb-6">
                Why Choose <span className="text-accent">Orel</span> for MBBS in
                Russia?
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="max-w-2xl">
              <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
                The <span className="text-accent">Orel</span> Advantage
              </div>
