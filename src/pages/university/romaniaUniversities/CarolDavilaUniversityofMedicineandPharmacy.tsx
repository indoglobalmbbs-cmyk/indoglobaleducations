...
const CarolDavilaUniversityofMedicineandPharmacy = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              Carol Davila University of Medicine and Pharmacy, also known as
              UMFCD, is a public medical university located in Bucharest,
              Romania. It is one of the oldest and most prestigious medical
              institutions in Romania, with a tradition of more than 160 years
              in medical and pharmaceutical education. The university traces its
              origins to the National School of Medicine and Pharmacy, founded
              in 1857 by the Romanian-French physician Carol Davila. The
              university offers study programs in major healthcare fields such
              as Medicine, Dentistry, Pharmacy, Nursing, Midwifery, and related
              medical sciences. It is especially known for training future
              doctors, dentists, pharmacists, and healthcare professionals
              through a combination of theoretical learning, laboratory
              practice, and clinical training.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={caroldavilauniversityofmedicineandpharmacy}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Carol Davila University of Medicine and Pharmacy is a leading
                institution for medical education in Romania, offering a
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Carol Davila University of Medicine and Pharmacy has played a
                  pivotal role in the advancement of medical sciences and the
                  education of medical professionals. Consistently ranked among
                  the <strong>top 10 medical institutes in Romania</strong>, it
                  stands out in the yearly official ratings among the 48
                  Romanian Institutes of Medical Education.
                </p>
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Carol Davila University of Medicine and Pharmacy
                  is recognized as one of the largest centers for medical
                  research, education, and science. The Academy is renowned for
                  its highly qualified teaching staff, extensive laboratory
                  facilities, and robust clinical base.
                </p>
              </div>
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Carol Davila University of Medicine and
              Pharmacy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Carol Davila University of Medicine and
              Pharmacy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Carol Davila University of Medicine and
                Pharmacy library is a cornerstone of academic life. It houses a
                massive collection of over{' '}
                <strong className="text-primary">440,000 copies</strong>
                of books from both Romanian and international authors.
              </p>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Carol Davila University of Medicine and Pharmacy provides a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Carol Davila University of Medicine and Pharmacy
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 bg-surface rounded-2xl border-l-4 border-primary shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                ...
                is standardized across Romanian medical universities to ensure
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            ...
            <p className="text-text-muted max-w-2xl mx-auto">
              Explore other premier medical institutions in Romania recognized
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Carol Davila University of Medicine and Pharmacy
            </div>
...
export default CarolDavilaUniversityofMedicineandPharmacy;
