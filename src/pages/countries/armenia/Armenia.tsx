    ...
    <div className="bg-gray-50 min-h-screen">
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="md:w-1/2">
            <div className="text-3xl font-bold text-primary mb-6">
              Why Choose Armenia for Higher Education?
            </div>
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-6">
          <div className="mb-10">
            <div className="text-3xl font-bold text-primary mb-4">
              Study MBBS in Armenia for Indian Students 2024-25
            </div>
            <div className="h-1.5 w-20 bg-accent rounded-full mb-8"></div>
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-6 text-gray-700 leading-relaxed">
                <p>
                  MBBS in Armenia is a popular option for medical students from
                  ...
                  world’s top 100 medical universities, Armenia offers excellent
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="text-sm">
                    ...
                    <tr className="border-b border-gray-100 bg-gray-50">
                      ...
                      <td className="p-4 text-gray-600">English & Armenian</td>
                    </tr>
                    <tr>
                      <td className="p-4 font-bold text-primary">
                        Top Ranked Unis
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Many students from India and other countries choose Armenia for
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="p-8 bg-primary-light rounded-2xl border-t-4 border-accent">
              ...
              <p className="text-text-muted mb-4">
                The MBBS program in Armenia lasts for <strong>6 years</strong>.
              </p>
            ...
            <div className="p-8 bg-primary-light rounded-2xl border-t-4 border-primary">
              ...
              <p className="text-sm text-text-muted italic">
                Support for learning Armenian is provided to help students
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              },
              {
                step: '06',
                title: 'Departure',
                desc: 'Fly to Armenia and begin your journey.',
              },
            ].map((item, idx) => (
              <div
                key={idx}
            ...
            {[
              {
                ...
                desc: 'Directly governed by the Armenian government, ensuring stability and standards.',
              },
              {
                icon: <FaMoneyBillWave />,
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              MBBS in Armenia Fees Structure 2024-25
            </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Armenian medical universities offer a blend of high academic
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3">
                  {[
                    'Bilingual medium of instruction (English & Armenian)',
            ...
            <div className="lg:w-1/2 w-full">
              <div className="relative p-8 bg-primary rounded-3xl overflow-hidden text-white shadow-2xl">
                ...
                <p className="text-blue-100 text-sm mb-6 leading-relaxed relative z-10">
                  Armenian medical universities are renowned for their
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl font-bold text-primary mb-4">
              MBBS Syllabus in Armenia (6 Years)
            </div>
            <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-10 bg-gray-100">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Comparison: MBBS in Armenia vs. MBBS in India
            </div>
            <p className="text-gray-600">
              ...
              <tbody className="text-gray-700">
                ...
                <tr className="border-b border-gray-50">
                  ...
                  <td className="p-5 text-center text-success font-medium">
                    Highly subsidized by the Armenian Government.
                  </td>
                  <td className="p-5 text-center">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20">
              ...
              <p className="text-sm text-blue-100 mb-4">
                The Armenian Federation offers full-funded seats covering
            ...
            <div className="lg:w-1/2">
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    step: 'Stay in Armenia',
                    text: 'Eligible to practice medicine or pursue specialized PG within the Armenian Federation.',
                  },
                  {
                    step: 'PG Abroad',
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                ...
                <div className="mt-6 p-4 bg-red-50 rounded-lg border-l-4 border-red-500">
                  <p className="text-xs text-red-700 font-medium italic">
                    Note: Armenian PG degrees are currently not recognized in
      ...
      <section className="py-10 bg-gray-100">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="space-y-4">
            {[
              {
                q: 'What is the NEET score required for MBBS in Armenia?',
                a: 'To study MBBS in Armenia, Indian students generally need a qualifying NEET score. For the current cycle, this is typically around 164 for the General category and 129 for reserved categories (OBC/SC/ST).',
              },
              {
              ...
              {
                q: 'Can Armenian medical graduates work in India?',
                a: 'Yes, degrees from NMC/WHO-approved Armenian universities are valid in India. To practice, graduates must clear the National Exit Test (NEXT), which has replaced the FMGE as the mandatory licensing exam for all medical graduates.',
              },
              {
                q: 'Do students get holidays in Armenia?',
              ...
              },
              {
                ...
                a: 'Armenia is generally very safe for international students. Most universities have 24/7 campus security and CCTV-monitored hostels. Armenia maintains a high ranking on the global safety index for students.',
              },
            ].map((faq, index) => (
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Armenian Medical Universities
            </div>
            <p className="text-gray-600 max-w-2xl mx-auto">
