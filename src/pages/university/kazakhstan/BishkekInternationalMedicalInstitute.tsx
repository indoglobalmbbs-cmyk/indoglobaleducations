...
const BishkekInternationalMedicalInstitute = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              The Bishkek International Medical Institute (BIMI) was founded in
              2019. BIMI offers the opportunity to study in one of the modern
              educational medical centers in Kyrgyzstan and Central Asia. The
              students encouraged to build their knowledge based on the high
              qualified teaching staff and excellent teaching base on the
              practical skills within BIMI medical clinics. BIMI offers
              education, based on the authors technologies teaching by highly
              qualified academic staff teachers; a lot of attention is paid to
              developing practical skills for future doctors; up to day well
              equipped modern computer simulation center; and other modern
              educational technologies.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={bishkekinternationalmedicalinstitute}
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              <div className="mb-10 text-left">
                <div className="text-3xl font-bold text-primary mb-4">
                  About Bishkek International Medical Institute
                </div>
                <div className="h-1.5 w-20 bg-accent rounded-full"></div>
              </div>
              <p className="text-text-muted leading-relaxed mb-4">
                Bishkek International Medical Institute is a leading institution
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Bishkek International Medical Institute has played a pivotal
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Bishkek International Medical Institute is
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Bishkek International Medical Institute
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Bishkek International Medical Institute
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Bishkek International Medical Institute
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Bishkek International Medical Institute provides a comfortable
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Bishkek International Medical Institute
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Bishkek International Medical Institute
            </div>
...
export default BishkekInternationalMedicalInstitute;
