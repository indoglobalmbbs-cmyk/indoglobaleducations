...
const IuliuHatieganuUniversityofMedicineandPharmacy = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              A state institution, Iuliu Haţieganu University of Medicine and
              Pharmacy Cluj-Napoca is the inheritor of a tradition of medical
              education in the Romanian border city of Cluj-Napoca, which long
              predates its own foundation as a Romanian-medium faculty of
              medicine in 1919. It was the first in Transylvania, in the
              immediate aftermath of the region’s annexation from Hungary at the
              end of the First World War. That tradition dates back until 1775,
              and in the years before 1918 was carried out under the auspices of
              the Franz Josef University, Kolasvar – the city’s name under
              Hungarian rule. Its trajectory in the century since has continued
              to reflect regional political vicissitudes, with the Franz Josef
              name restored under occupation between 1940 and 1945, the creation
              of an independent medico-pharmaceutical institution under the
              Communists in 1948 and renaming as the University of Medicine in
              1990.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={iuliuhatieganuuniversityofmedicineandpharmacy}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Iuliu Hatieganu University of Medicine and Pharmacy is a leading
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Iuliu Hatieganu University of Medicine and Pharmacy has played
                  a pivotal role in the advancement of medical sciences and the
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Iuliu Hatieganu University of Medicine and
                  Pharmacy is recognized as one of the largest centers for
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Iuliu Hatieganu University of Medicine and
              Pharmacy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Iuliu Hatieganu University of Medicine and
              Pharmacy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Iuliu Hatieganu University of Medicine
                and Pharmacy library is a cornerstone of academic life. It
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Iuliu Hatieganu University of Medicine and Pharmacy provides a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Iuliu Hatieganu University of Medicine and
              Pharmacy
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Iuliu Hatieganu University of Medicine and Pharmacy
            </div>
...
export default IuliuHatieganuUniversityofMedicineandPharmacy;
