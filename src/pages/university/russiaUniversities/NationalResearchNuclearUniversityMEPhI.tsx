...
const NationalResearchNuclearUniversityMEPhI = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              MEPhI is a research and educational center with honourable
              traditions and a clear vision of the future where world’s best
              tech experts excel in creating applicable science, boost economic
              output in various fields, support industry and business. MEPhI is
              a leading Russian university which augments its positions on the
              global educational scene. MEPhI is proud of ambitious and skilled
              experts in science and engineering who have graduated the
              University since its establishment in 1942. Six Nobel laureates
              contributed to educational process and research activities at
              MEPhI. And now relying on extensive experience we are creating a
              future with a new generation of explorers and inventors.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={nationalresearchnuclearuniversitymephi}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                National Research Nuclear University MEPhI is a leading
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for National Research Nuclear University MEPhI
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for National Research Nuclear University MEPhI
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the National Research Nuclear University
                MEPhI library is a cornerstone of academic life. It houses a
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                National Research Nuclear University MEPhI provides a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at National Research Nuclear University MEPhI
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at National Research Nuclear University MEPhI
            </div>
...
export default NationalResearchNuclearUniversityMEPhI;
