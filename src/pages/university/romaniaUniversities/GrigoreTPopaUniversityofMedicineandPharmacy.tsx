...
const GrigoreTPopaUniversityofMedicineandPharmacy = () => {
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row items-center">
          <div className="md:w-1/2">
            ...
            <p className="mb-6 text-text-muted leading-relaxed">
              G.T. Popa (Grigore T. Popa) University of Medicine and Pharmacy,
              founded in 1879, offered a course in medicine only. Later, the
              university collaborated with two more institutions to form the
              Departments of Pharmacy and Dental Medicine. Further, a program in
              bioengineering was added at G.T. Popa University of Medicine and
              Pharmacy, Iasi, and the university is the only one to offer this
              course. By producing experts in the field of medicine for over 100
              years, the university offers more than 4 courses, in the English
              language. With the latest approach in the field of medical science
              and research, the institute is well-known for its quality
              education, as well as its facilities.
            </p>
          </div>
          <div className="md:w-1/2">
            <img
              src={grigoretPopauniversityofmedicineandpharmacy}
          ...
          <div className="lg:w-2/3 w-full space-y-12">
            <div>
              ...
              <p className="text-text-muted leading-relaxed mb-4">
                Grigore T. Popa University of Medicine and Pharmacy is a leading
            ...
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <div className="space-y-4">
                <p className="text-text-muted leading-relaxed">
                  Grigore T. Popa University of Medicine and Pharmacy has played
                ...
                <p className="text-text-muted leading-relaxed">
                  As of 2018, Grigore T. Popa University of Medicine and
      ...
      <section className="py-10 px-4 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 text-center md:text-left">
            <div className="text-3xl font-bold text-primary mb-4">
              Required Documents for Grigore T. Popa University of Medicine and
              Pharmacy
            </div>
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center">
            <div className="text-3xl font-bold text-primary mb-4">
              Admission Process for Grigore T. Popa University of Medicine and
              Pharmacy
            </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6">
              ...
              <p className="text-text-muted leading-relaxed">
                Established in 1936, the Grigore T. Popa University of Medicine
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/3">
              ...
              <p className="text-text-muted leading-relaxed mb-6">
                Grigore T. Popa University of Medicine and Pharmacy provides a
      ...
      <section className="py-10 px-4 bg-primary-light">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="text-3xl font-bold text-primary mb-4">
              Student Life at Grigore T. Popa University of Medicine and
              Pharmacy
            </div>
      ...
      <section className="py-10 bg-primary-light">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <div className="text-3xl md:text-4xl font-bold text-primary mb-4">
              Life at Grigore T. Popa University of Medicine and Pharmacy
            </div>
...
export default GrigoreTPopaUniversityofMedicineandPharmacy;
